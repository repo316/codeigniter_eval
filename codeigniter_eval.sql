...
CREATE TABLE `user_activities`  (
  ...
  `message_from` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `datetime` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `timestamp` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `activities_user_index`(`uid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user_activities
-- ----------------------------
INSERT INTO `user_activities` VALUES (1, 1, 'test 1', 'test 1 from', '2022-02-03 12:33:11', '1661463821');
INSERT INTO `user_activities` VALUES (2, 1, 'test 2', 'test 2 from', '2022-02-03 12:33:11', '1661463821');
...
CREATE TABLE `users`  (
  ...
  `email` varchar(60) CHARACTER SET utf8 COLLATE utf8_slovenian_ci NOT NULL,
  `password` varchar(32) CHARACTER SET utf8 COLLATE utf8_slovenian_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `email_user_index`(`email`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_slovenian_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'lsolis1@test.co', '25d55ad283aa400af464c76d713c07ad');
INSERT INTO `users` VALUES (3, 'lsolis2@test.cr', '25d55ad283aa400af464c76d713c07ad');
INSERT INTO `users` VALUES (4, 'lsolis3@test.mx', '25d55ad283aa400af464c76d713c07ad');
INSERT INTO `users` VALUES (5, 'reposolis@gmail.com', '12345678');
INSERT INTO `users` VALUES (6, 'lsolis32@test.cr', '1234567899');
INSERT INTO `users` VALUES (7, 'lsolis33@test.cr', '1234567899');
INSERT INTO `users` VALUES (8, 'lsolis34@test.cr', '1234567899');
INSERT INTO `users` VALUES (9, 'lsolis35@test.cr', '1234567899');
